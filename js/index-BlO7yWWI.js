...
function PortfolioShell({ children }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "container mx-auto px-4 sm:px-6 lg:px-8 max-w-6xl", children }) });
}
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "nav",
    {
      className: cn(
        ...
        isScrolled ? "bg-background/95 backdrop-blur-sm border-b border-border shadow-md" : "bg-transparent"
      ),
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between h-16", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-base font-bold text-foreground group-hover:text-accent transition-colors", children: "<Gowshick.T />" })
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "hidden md:flex items-center gap-1", children: navItems.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            Button,
            {
              variant: "ghost",
              size: "sm",
              ...
              className: cn(
                ...
                activeSection === item.id ? "text-accent bg-accent/10" : "text-muted-foreground hover:text-foreground hover:bg-accent/5"
              ),
              children: item.label
            },
            item.id
        ...
        isOpen && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "md:hidden bg-background/98 backdrop-blur-sm border-b border-border", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-4 py-4 space-y-2", children: navItems.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          Button,
          {
            variant: "ghost",
            size: "sm",
...
function Section({ id, title, icon, children, className }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { id, className: cn("py-16 md:py-20", className), children: [
    title && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 mb-8", children: [
      icon && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-accent", children: icon }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-2xl md:text-3xl font-bold text-foreground", children: title })
    ] }),
    children
  ] });
}
...
function ExperienceTimeline() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-shrink-0 w-12 h-12 rounded-full bg-accent/30 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Building2, { className: "w-6 h-6 text-accent" }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "bg-transparent border-0 shadow-none", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(CardHeader, { className: "p-0 pb-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap items-start justify-between gap-2", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { className: "text-lg", children: "Front-End Developer" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap items-center gap-2 mt-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "secondary", className: "text-xs", children: "Assembly Global" }) })
        ] }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap gap-4 text-sm text-muted-foreground mt-3", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-2 mt-3 p-3 bg-muted/30 rounded-lg border border-border/50", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Info, { className: "w-4 h-4 text-accent flex-shrink-0 mt-0.5" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "Previously ADK Rage (acquired by Assembly Global in 2025)" })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "p-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Accordion, { type: "single", collapsible: true, className: "w-full", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(AccordionItem, { value: "responsibilities", className: "border-0", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(AccordionTrigger, { className: "text-sm font-medium hover:text-accent transition-colors py-3", children: "View Responsibilities & Achievements" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(AccordionContent, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "space-y-3 text-sm text-muted-foreground", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex gap-3", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Developed and maintained responsive web applications using HTML5, CSS3, SCSS, JavaScript, and modern frameworks (Next.js, Astro.js)." })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex gap-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-accent mt-1", children: "•" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Designed and implemented email templates, CloudPages, and automated customer journeys in Salesforce Marketing Cloud." })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex gap-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-accent mt-1", children: "•" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Collaborated with designers and back-end developers to deliver pixel-perfect, cross-browser compatible solutions." })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex gap-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-accent mt-1", children: "•" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Optimized web performance, achieving 95+ PageSpeed scores on mobile devices." })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex gap-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-accent mt-1", children: "•" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Upgraded legacy Drupal templates to modern SCSS/JS architecture, improving maintainability and performance." })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex gap-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-accent mt-1", children: "•" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Automated SFMC email journeys, reducing manual campaign effort by 60%." })
          ] })
        ] }) })
      ] }) }) })
    ] }) })
...
function QuickActions() {
  ...
  const [copiedPhone, setCopiedPhone] = reactExports.useState(false);
  const handleCopyPhone = async () => {
    const success = await copy("+91 6382762653");
    if (success) {
      setCopiedPhone(true);
      ue.success("Phone number copied to clipboard!");
      setTimeout(() => setCopiedPhone(false), 2e3);
    } else {
      ue.error("Failed to copy phone number");
    }
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap justify-center gap-3", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      Button,
      {
        variant: "default",
        size: "sm",
        asChild: true,
        className: "border-2 border-accent/50 hover:border-accent transition-all",
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("a", { href: "mailto:thirugowshi00@gmail.com", "aria-label": "Send email", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      Button,
      {
        ...
        className: "bg-card hover:bg-accent/20 hover:border-accent transition-all",
        "aria-label": "Copy phone number",
        children: copiedPhone ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
...
const projects = [
  {
    name: "Siva Digitals",
    url: "https://sivadigitals.com/",
    description: "Digital solutions and web development services"
  },
  {
    name: "Pumpa",
    url: "https://pumpa.sivadigitals.com",
    description: "Innovative web application platform"
  },
  {
    name: "Smatal",
    url: "https://www.smatal.in/",
    description: "Smart technology and automation solutions"
  },
  {
    name: "B Global India",
    url: "https://bglobalindia.com/",
    description: "Global business and consulting services"
  }
];
function PersonalProjectsSection() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid md:grid-cols-2 gap-6", children: projects.map((project, index2) => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-card border border-border rounded-xl overflow-hidden hover:shadow-lg transition-all duration-300 hover:scale-[1.02]", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "bg-transparent border-0 shadow-none", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(CardHeader, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(CardTitle, { className: "text-base flex items-center justify-between", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: project.name }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(ExternalLink, { className: "w-5 h-5 text-accent" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(CardDescription, { className: "text-muted-foreground text-sm", children: project.description })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      Button,
      {
        ...
        size: "sm",
        asChild: true,
        className: "w-full border-accent/30 hover:border-accent hover:bg-accent/10 transition-all text-sm",
...
const competencies = [
  {
    icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Code, { className: "w-6 h-6" }),
    title: "Modern Web Development",
    description: "Expert in HTML5, CSS3/SCSS, JavaScript, and modern frameworks like Next.js and Astro.js for building scalable web applications."
  },
  {
  ...
  },
  {
    ...
    description: "Delivering high-performance web experiences with 95+ PageSpeed scores through code optimization and best practices."
  },
  {
    icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Users, { className: "w-6 h-6" }),
    title: "Cross-Functional Collaboration",
    description: "Working effectively with designers, back-end developers, and stakeholders to deliver cohesive digital solutions."
  },
  {
    icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Globe, { className: "w-6 h-6" }),
    title: "Cross-Browser Compatibility",
    description: "Ensuring consistent user experiences across all major browsers and platforms with thorough testing."
  },
  {
    icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Wrench, { className: "w-6 h-6" }),
    title: "Marketing Automation",
    description: "Designing and implementing automated email campaigns and customer journeys in Salesforce Marketing Cloud."
  }
];
function CoreCompetenciesSection() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid md:grid-cols-2 lg:grid-cols-3 gap-6", children: competencies.map((competency, index2) => /* @__PURE__ */ jsxRuntimeExports.jsx(
    "div",
    {
      className: "bg-card border border-border rounded-xl overflow-hidden hover:shadow-lg transition-all duration-300 hover:scale-[1.02]",
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "bg-transparent border-0 shadow-none h-full", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 mb-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-shrink-0 w-10 h-10 rounded-lg bg-accent/20 flex items-center justify-center text-accent", children: competency.icon }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { className: "text-base", children: competency.title })
        ] }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground leading-relaxed", children: competency.description }) })
      ] })
    },
    index2
  )) });
...
function App() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(J, { attribute: "class", defaultTheme: "dark", enableSystem: true, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative min-h-screen bg-background", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(PortfolioNav, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(PortfolioShell, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Section, { id: "hero", className: "min-h-screen flex items-center justify-center pt-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center space-y-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-center mb-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-gradient-to-br from-accent/30 to-primary/30 rounded-full blur-3xl animate-pulse" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "img",
            {
              src: "/assets/gowshick-avatar.dim_512x512.png",
              alt: "Gowshick T",
              className: "relative w-32 h-32 md:w-40 md:h-40 rounded-full border-2 border-accent/50 shadow-lg ring-2 ring-accent/20"
            }
          )
        ] }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight bg-gradient-to-br from-foreground via-foreground to-accent bg-clip-text text-transparent", children: "Gowshick T" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg md:text-xl text-muted-foreground font-light", children: "Front-End Developer" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap justify-center gap-4 text-sm text-muted-foreground", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-center gap-3 pt-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Button,
            {
              variant: "outline",
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "a",
                {
                  href: "https://www.linkedin.com/in/gowshick-t-292a19225/",
                  target: "_blank",
                  rel: "noopener noreferrer",
                  "aria-label": "LinkedIn Profile",
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(SiLinkedin, { className: "w-4 h-4 mr-2" }),
                    "LinkedIn"
                  ]
                }
              )
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Button,
            {
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "a",
                {
                  href: "https://www.instagram.com/gowshi_the_destroyer/",
                  target: "_blank",
                  rel: "noopener noreferrer",
                  "aria-label": "Instagram Profile",
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(SiInstagram, { className: "w-4 h-4 mr-2" }),
                    "Instagram"
                  ]
                }
              )
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "pt-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(QuickActions, {}) })
      ] }) }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Section, { id: "summary", title: "About Me", icon: /* @__PURE__ */ jsxRuntimeExports.jsx(CodeXml, { className: "w-6 h-6" }), children: /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-card border border-border rounded-xl p-6 hover:shadow-lg transition-all", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: "bg-transparent border-0 shadow-none", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "pt-0", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-base leading-relaxed text-muted-foreground", children: [
          "Front-End Developer with ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-foreground font-semibold", children: "around 4 years of experience" }),
          " building high-performance, responsive, and user-centric web applications. Expertise in modern HTML5, CSS3/SCSS, JavaScript, and frameworks like Next.js and Astro.js. Proven track record in ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-foreground font-semibold", children: "Salesforce Marketing Cloud" }),
          "—designing responsive email templates, CloudPages, and automating customer journeys. Skilled at collaborating with cross-functional teams to deliver scalable, accessible, and cross-browser compatible digital experiences."
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Separator, { className: "my-4 bg-accent/20" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-base leading-relaxed text-muted-foreground", children: [
          "Currently ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-foreground font-semibold", children: "freelancing" }),
          " and have successfully completed ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-foreground font-semibold", children: "10+ projects" }),
          ", delivering tailored web solutions for diverse clients."
        ] })
      ] }) }) }) }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Section, { id: "competencies", title: "Core Competencies", icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Target, { className: "w-6 h-6" }), children: /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(CoreCompetenciesSection, {}) }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Section, { id: "skills", title: "Technical Skills", icon: /* @__PURE__ */ jsxRuntimeExports.jsx(CodeXml, { className: "w-6 h-6" }), children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid md:grid-cols-2 gap-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { delay: 0.1, children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-card border border-border rounded-xl overflow-hidden hover:shadow-lg transition-all hover:scale-[1.02]", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "bg-transparent border-0 shadow-none", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { className: "text-base", children: "Languages" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-2", children: ["HTML5", "CSS3", "SCSS", "JavaScript", "jQuery", "AMPscript"].map((skill) => /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "secondary", className: "hover:bg-accent/20 transition-all cursor-default text-sm", children: skill }, skill)) }) })
        ] }) }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { delay: 0.2, children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-card border border-border rounded-xl overflow-hidden hover:shadow-lg transition-all hover:scale-[1.02]", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "bg-transparent border-0 shadow-none", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { className: "text-base", children: "Frameworks" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-2", children: ["Bootstrap", "TailwindCSS", "Astro.js", "Next.js"].map((skill) => /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "secondary", className: "hover:bg-accent/20 transition-all cursor-default text-sm", children: skill }, skill)) }) })
        ] }) }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { delay: 0.3, children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-card border border-border rounded-xl overflow-hidden hover:shadow-lg transition-all hover:scale-[1.02]", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "bg-transparent border-0 shadow-none", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { className: "text-base", children: "Tools" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-2", children: ["Salesforce Marketing Cloud", "Automation Studio", "Journey Builder", "Email Studio"].map((skill) => /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "secondary", className: "hover:bg-accent/20 transition-all cursor-default text-sm", children: skill }, skill)) }) })
        ] }) }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { delay: 0.4, children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-card border border-border rounded-xl overflow-hidden hover:shadow-lg transition-all hover:scale-[1.02]", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "bg-transparent border-0 shadow-none", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { className: "text-base", children: "Other" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-2", children: ["Responsive Design", "Cross-Browser Optimization", "Performance Tuning"].map((skill) => /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "secondary", className: "hover:bg-accent/20 transition-all cursor-default text-sm", children: skill }, skill)) }) })
        ] }) }) })
      ] }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Section, { id: "experience", title: "Professional Experience", icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Briefcase, { className: "w-6 h-6" }), children: /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-card border border-border rounded-xl p-6", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ExperienceTimeline, {}) }) }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Section, { id: "projects", title: "Personal Projects", icon: /* @__PURE__ */ jsxRuntimeExports.jsx(FolderOpen, { className: "w-6 h-6" }), children: /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(PersonalProjectsSection, {}) }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Section, { id: "achievements", title: "Key Achievements", icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Award, { className: "w-6 h-6" }), children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-4", children: [
        "Automated SFMC email journeys, reducing manual campaign effort by 60%.",
        "Delivered 15+ high-converting landing pages with 95+ PageSpeed score on mobile.",
        "Upgraded legacy Drupal templates to modern SCSS/JS architecture for improved maintainability."
      ].map((achievement, index2) => /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { delay: index2 * 0.1, children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-card border border-border rounded-xl p-6 hover:shadow-lg transition-all hover:translate-x-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: "bg-transparent border-0 shadow-none", children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "pt-0", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-shrink-0 w-8 h-8 rounded-full bg-accent/30 flex items-center justify-center text-accent font-bold text-sm", children: index2 + 1 }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground leading-relaxed text-sm", children: achievement })
      ] }) }) }) }) }, index2)) }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Section, { id: "education", title: "Education", icon: /* @__PURE__ */ jsxRuntimeExports.jsx(GraduationCap, { className: "w-6 h-6" }), children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { delay: 0.1, children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-card border border-border rounded-xl overflow-hidden hover:shadow-lg transition-all", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "bg-transparent border-0 shadow-none", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(CardHeader, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { className: "text-base", children: "B.Sc in Computer Science" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: "2018 – 2021" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm", children: "SLS MAVMM AV College of Arts (Affiliated to Kamaraj University)" }) })
        ] }) }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { delay: 0.2, children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-card border border-border rounded-xl overflow-hidden hover:shadow-lg transition-all", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "bg-transparent border-0 shadow-none", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(CardHeader, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { className: "text-base", children: "Higher Secondary (HSC)" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: "2016 – 2018" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm", children: "Govt. Higher Secondary School, Melur" }) })
        ] }) }) })
      ] }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Section, { id: "additional", title: "Additional Information", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-card border border-border rounded-xl p-6 hover:shadow-lg transition-all", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: "bg-transparent border-0 shadow-none", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "pt-0 space-y-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-base font-semibold text-foreground mb-2", children: "Languages" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm", children: "Tamil (Native), English (Professional)" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Separator, { className: "bg-accent/20" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-base font-semibold text-foreground mb-2", children: "Interests" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm", children: "Web Performance Optimization, Modern CSS Techniques, Email Marketing Automation" })
        ] })
      ] }) }) }) }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "mt-20 py-8 border-t border-border", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-center text-sm text-muted-foreground", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
